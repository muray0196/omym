...
from omym.core.operations.preview import format_text_output, format_json_output, preview_files
from omym.core.path_generator import PathInfo
...
def test_preview_single_file(tmp_path: Path, mocker: MockerFixture) -> None:
    ...
    mock_db = mocker.patch("omym.core.operations.preview.DatabaseManager")
    mock_instance = mock_db.return_value.__enter__.return_value
    mock_instance.conn = True

    # Mock filter DAO
    mock_filter = mocker.patch("omym.core.operations.preview.FilterDAO")
    mock_filter_instance = mock_filter.return_value
    mock_filter_instance.get_hierarchies.return_value = []

    # Mock music grouper
    mock_grouper = mocker.patch("omym.core.operations.preview.MusicGrouper")
    ...
    # Mock path generator
    mock_generator = mocker.patch("omym.core.operations.preview.PathGenerator")
